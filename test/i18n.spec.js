...
describe('#getString', () => {
	...
	it('should return correct string multiple parameters', () => {
		...
		expect(result).to.be.eq('test string p1, p2 and p3');
	});
});
